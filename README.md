...
![filebeat-playbook.yml](https://github.com/janetna40/ELK-STACK-Project1/blob/main/Ansible/filebeat-playbook.yml) (Installs and configures Filebeat on the target machines)
